...
def parse_excel():
    ...
    summary = pd.read_excel("New Client Allocation Template.xlsx", sheet_name = "Summary", skiprows=45)
    ...
    summary = pd.read_excel("New Client Allocation Template.xlsx", sheet_name = "Summary", skiprows=0)
